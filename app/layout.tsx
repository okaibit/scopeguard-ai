        ...
        <nav className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              <a
                href="/pr-intake"
                className="rounded-full px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100 hover:text-slate-950 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
              >
                Start Audit
              </a>
              ...
              <a
                ...
                className="rounded-full border border-cyan-400/20 bg-cyan-400/5 px-3 py-2 text-sm font-semibold text-cyan-400 transition hover:bg-cyan-400/10"
              >
                Audit Dashboard
              </a>
